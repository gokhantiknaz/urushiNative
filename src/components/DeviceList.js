...
const DeviceList = (props) => {
    ...
    const renderSeparator = () => {
        return (<View
            style={{
                height: 1, width: width, backgroundColor: '#CED0CE',
    ...
    return (<View style={styles.container}>
        ...
        <View>
            ...
            <FlatList
                ...
                renderItem={({item}) => {
                    return (<TouchableOpacity onPress={() => setSelectedItem(item)}>
                        <View
                            style={{
                            ...
                            {item.isSelect && <Image
                                ...
                                style={{marginRight: 16, height: 20, width: 20}}
                            />}
                            <Text category='s1' style={{color: 'white'}}>{`${item.name} ${item.id}`}</Text>
                        </View>
                    </TouchableOpacity>);
                }}
            />
...
const styles = StyleSheet.create({
        ...
        fontSize: 15, paddingVertical: 15, fontWeight: 'bold', textAlign: 'center', color: "white"
    }, flatlist: {
        ...
        backgroundColor: 'green', height: 1,
